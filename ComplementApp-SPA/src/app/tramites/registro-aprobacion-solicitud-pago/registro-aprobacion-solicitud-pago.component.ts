...
@Component({
  selector: 'app-registro-aprobacion-solicitud-pago',
  templateUrl: './registro-aprobacion-solicitud-pago.component.html',
  styleUrls: ['./registro-aprobacion-solicitud-pago.component.scss']
})
export class RegistroAprobacionSolicitudPagoComponent implements OnInit {
