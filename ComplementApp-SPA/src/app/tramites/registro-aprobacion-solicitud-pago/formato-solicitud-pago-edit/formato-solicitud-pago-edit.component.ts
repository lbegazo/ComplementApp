...
import { PopupSolicitudPagoEditComponent } from './popup-solicitud-pago-edit/popup-solicitud-pago-edit.component';

@Component({
  selector: 'app-formato-solicitud-pago-edit',
  templateUrl: './formato-solicitud-pago-edit.component.html',
  styleUrls: ['./formato-solicitud-pago-edit.component.scss'],
})
export class FormatoSolicitudPagoEditComponent implements OnInit {
